...
OPTION(t2ce_cache_path, OPT_STR)
OPTION(t2ce_cache_size, OPT_U64)  // 10gb for testing
OPTION(t2ce_cache_create, OPT_BOOL)
OPTION(t2ce_dev_flush, OPT_BOOL)
OPTION(t2ce_aio_threads, OPT_U64)
...
OPTION(bluestore_debug_kv_sync_t2cache_meta, OPT_BOOL)
